...
port = "COM12"  # Sesuaikan dengan port di Raspberry Pi, biasanya "/dev/ttyACM0" atau "/dev/ttyUSB0"
...
try:
    while True:
        # Ambil frame dari PiCamera2
        img = picam2.capture_array()
        
        # Convert dari RGB ke BGR untuk OpenCV
